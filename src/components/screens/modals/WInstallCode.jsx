        ...
        <div style={{
          ...
          <div style={{ padding: 14 }}>
            ...
            <div style={{ background: "var(--bg-2)", border: "1px solid var(--border)", borderRadius: 8, padding: 10, fontFamily: "monospace", fontSize: 10.5, lineHeight: 1.5, marginBottom: 10, wordBreak: "break-all" }}>
              <span style={{ color: "#6E6890" }}>&lt;!-- ConsentBit --&gt;</span> <span style={{ color: "#FF9F45" }}>&lt;script</span> <span style={{ color: "#5AE497" }}>id="cookieyes" src="https://cdn-cookieyes.com/client_data/.../script.js"</span><span style={{ color: "#FF9F45" }}>&gt;&lt;/script&gt;</span>
            </div>
