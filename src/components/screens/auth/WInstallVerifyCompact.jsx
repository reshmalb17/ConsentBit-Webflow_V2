...
import { WCollapse } from "../../kit/WCollapse.jsx";
import { Icon } from "../../lib/icons.jsx";

function WInstallVerifyCompact() {
    ...
    <WAuthShell step={3} topAlign title="Install & verify" subtitle="Add the banner to your site, then confirm it's live.">
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14, alignItems: "start" }}>
        ...
        <div className="card" style={{ padding: 12 }}>
          ...
          <WCollapse label="View Webflow guide">
            <img src={window.__resources && window.__resources.webflowHeadcode || "assets/webflow-headcode.png"} alt="Webflow head code panel" style={{ display: "block", width: "100%", borderRadius: 8, border: "1px solid var(--border)" }} />
          </WCollapse>
        ...
        <div className="card" style={{ padding: 12 }}>
          ...
          <div style={{ display: "flex", gap: 10, background: "var(--purple-soft)", border: "1px solid var(--purple)", borderRadius: 9, padding: 12, marginBottom: 12 }}>
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              <WCollapse label="View publish steps">
                <img src={window.__resources && window.__resources.webflowPublish || "assets/webflow-publish.png"} alt="Webflow publish destination dialog" style={{ display: "block", width: "100%", borderRadius: 8, border: "1px solid var(--border)" }} />
              </WCollapse>
